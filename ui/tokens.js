...
const USDT_TOKEN = { token: 'USDT', name: 'Tether USD', icon: 'https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/ethereum/assets/0xdAC17F958D2ee523a2206206994597C13D831ec7/logo.png',
    30:{symbol:'rUSDT', address:'0xe506F698B31a66049bD4653Ed934e7A07Cbc5549', decimals:18},
    31:{symbol:'rKovUSDT', address:'0xcdc8ccbbfb6407c53118fe47259e8d00c81f42cd', decimals:18},
...
const USDC_TOKEN = { token: 'USDC', name: 'USD Coin', icon: 'https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/ethereum/assets/0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48/logo.png',
    30:{symbol:'rUSDC', address:'0x5a42221d7aae8e185bc0054bb036d9757ec18857', decimals:18},
    31:{symbol:'rKovUSDC', address:'0x6117c9529f15c52e2d3188d5285c745b757b5825', decimals:18},
...
const TOKENS = [ DOC_TOKEN, DAI_TOKEN, SAI_TOKEN, BITPRO_TOKEN, RIF_TOKEN, LINK_TOKEN, TUSD_TOKEN, USDT_TOKEN, USDC_TOKEN, WETH_TOKEN, ZRX_TOKEN, FLIXX_TOKEN, RFOX_TOKEN ];