 ...
 * Example invocation:
 *
 * node fundFederation.js "http://localhost:8545" "key1, key2" "pkey" "100000"
 *
 */
...
if (scriptPath.indexOf('fundFederation') !== -1) {
    keys = keys.replace(/ /g, '').split(',') || [];
    fundFederation(host, keys, privateKey, amount);
}

async function fundFederation(host, keys, privateKey, amount) {
